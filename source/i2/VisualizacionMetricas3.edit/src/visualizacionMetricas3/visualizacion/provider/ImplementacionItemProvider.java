...
/**
 * This is the item provider adapter for a {@link visualizacionMetricas3.visualizacion.Implementacion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImplementacionItemProvider extends ConectorItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Implementacion)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Implementacion_type") :
			getString("_UI_Implementacion_type") + " " + label;
	}
