 ...
 * <ul>
 *   <li>{@link subkdm.kdmObjects.impl.ClassUnitImpl#getCodeElement <em>Code Element</em>}</li>
 *   <li>{@link subkdm.kdmObjects.impl.ClassUnitImpl#isIsAbstract <em>Is Abstract</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassUnitImpl extends DataTypeImpl implements ClassUnit {
	...
	protected EClass eStaticClass() {
		return KdmObjectsPackage.Literals.CLASS_UNIT;
	}
	...
	public EList<CodeItem> getCodeElement() {
		if (codeElement == null) {
			codeElement = new EObjectContainmentEList<CodeItem>(CodeItem.class, this, KdmObjectsPackage.CLASS_UNIT__CODE_ELEMENT);
		}
		return codeElement;
	}
	...
	public void setIsAbstract(boolean newIsAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KdmObjectsPackage.CLASS_UNIT__IS_ABSTRACT, oldIsAbstract, isAbstract));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KdmObjectsPackage.CLASS_UNIT__CODE_ELEMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case KdmObjectsPackage.CLASS_UNIT__IS_ABSTRACT:
				return isIsAbstract();
		}
