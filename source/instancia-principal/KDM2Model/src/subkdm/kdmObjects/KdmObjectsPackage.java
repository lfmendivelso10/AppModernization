...
public interface KdmObjectsPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int MODEL_ELEMENT__ANNOTATION = 0;
	 ...
	 * @ordered
	 */
	int CODE_MODEL__ANNOTATION = MODEL_ELEMENT__ANNOTATION;
	 ...
	 * @ordered
	 */
	int ABSTRACT_CODE_ELEMENT__ANNOTATION = MODEL_ELEMENT__ANNOTATION;
	 ...
	 * @ordered
	 */
	int DATA_TYPE__ANNOTATION = CODE_ITEM__ANNOTATION;
	 ...
	 * @ordered
	 */
	int CLASS_UNIT__ANNOTATION = DATA_TYPE__ANNOTATION;
	 ...
	 * @ordered
	 */
	int INTERFACE_UNIT__ANNOTATION = DATA_TYPE__ANNOTATION;
	 ...
	 * @ordered
	 */
	int COMMENT_UNIT__ANNOTATION = MODEL_ELEMENT__ANNOTATION;
	 ...
	 * @ordered
	 */
	int COMMENT_UNIT__TEXT = MODEL_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int COMMENT_UNIT_FEATURE_COUNT = MODEL_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int COMMENT_UNIT_OPERATION_COUNT = MODEL_ELEMENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TEMPLATE_UNIT__ANNOTATION = DATA_TYPE__ANNOTATION;
	 ...
	 * @ordered
	 */
	int SIGNATURE__ANNOTATION = DATA_TYPE__ANNOTATION;
	 ...
	 * @ordered
	 */
	int ACTION_ELEMENT__ANNOTATION = ABSTRACT_CODE_ELEMENT__ANNOTATION;
	 ...
	 * @ordered
	 */
	int SEGMENT__ANNOTATION = MODEL_ELEMENT__ANNOTATION;
	...
	/**
	 * The meta object id for the '{@link subkdm.kdmObjects.impl.AnnotationImpl <em>Annotation</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see subkdm.kdmObjects.impl.AnnotationImpl
	 * @see subkdm.kdmObjects.impl.KdmObjectsPackageImpl#getAnnotation()
	 * @generated
	 */
	int ANNOTATION = 26;
	 ...
	 * @ordered
	 */
	int ANNOTATION__ANNOTATION = MODEL_ELEMENT__ANNOTATION;
	 ...
	 * @ordered
	 */
	int ANNOTATION__TEXT = MODEL_ELEMENT_FEATURE_COUNT + 0;
	...
	/**
	 * The meta object id for the '{@link subkdm.kdmObjects.impl.ClusterImpl <em>Cluster</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see subkdm.kdmObjects.impl.ClusterImpl
	 * @see subkdm.kdmObjects.impl.KdmObjectsPackageImpl#getCluster()
	 * @generated
	 */
	int CLUSTER = 27;
	 ...
	 * @ordered
	 */
	int CLUSTER__ANNOTATION = CODE_ITEM__ANNOTATION;
	 ...
	 * @ordered
	 */
	int CLUSTER__CODE_RELATION = CODE_ITEM__CODE_RELATION;
	 ...
	 * @ordered
	 */
	int CLUSTER__COMMENT = CODE_ITEM__COMMENT;
	 ...
	 * @ordered
	 */
	int CLUSTER__NAME = CODE_ITEM__NAME;
	 ...
	 * @ordered
	 */
	int CLUSTER__CODE_ELEMENT = CODE_ITEM_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int CLUSTER_FEATURE_COUNT = CODE_ITEM_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int CLUSTER_OPERATION_COUNT = CODE_ITEM_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link subkdm.kdmObjects.ModelElement#getAnnotation <em>Annotation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Annotation</em>'.
	 * @see subkdm.kdmObjects.ModelElement#getAnnotation()
	 * @see #getModelElement()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link subkdm.kdmObjects.Annotation <em>Annotation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Annotation</em>'.
	 * @see subkdm.kdmObjects.Annotation
	 * @generated
	 */
	EClass getAnnotation();

	/**
	 * Returns the meta object for the attribute '{@link subkdm.kdmObjects.Annotation#getText <em>Text</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Text</em>'.
	 * @see subkdm.kdmObjects.Annotation#getText()
	 * @see #getAnnotation()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link subkdm.kdmObjects.Cluster <em>Cluster</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Cluster</em>'.
	 * @see subkdm.kdmObjects.Cluster
	 * @generated
	 */
	EClass getCluster();

	/**
	 * Returns the meta object for the reference list '{@link subkdm.kdmObjects.Cluster#getCodeElement <em>Code Element</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Code Element</em>'.
	 * @see subkdm.kdmObjects.Cluster#getCodeElement()
	 * @see #getCluster()
	 * @generated
	 */
	EReference getCluster_CodeElement();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link subkdm.kdmObjects.impl.AnnotationImpl <em>Annotation</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see subkdm.kdmObjects.impl.AnnotationImpl
		 * @see subkdm.kdmObjects.impl.KdmObjectsPackageImpl#getAnnotation()
		...
		/**
		 * The meta object literal for the '{@link subkdm.kdmObjects.impl.ClusterImpl <em>Cluster</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see subkdm.kdmObjects.impl.ClusterImpl
		 * @see subkdm.kdmObjects.impl.KdmObjectsPackageImpl#getCluster()
		 ...
		 * @generated
		 */
		EReference CLUSTER__CODE_ELEMENT = eINSTANCE.getCluster_CodeElement();
