...
public class KdmRelationsAdapterFactory extends AdapterFactoryImpl {
	...
	protected KdmRelationsSwitch<Adapter> modelSwitch =
		new KdmRelationsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseClassLevelRelation(ClassLevelRelation object) {
				return createClassLevelRelationAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseClusterRelation(ClusterRelation object) {
				return createClusterRelationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link subkdm.kdmRelations.ClassLevelRelation <em>Class Level Relation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createClassLevelRelationAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link subkdm.kdmRelations.TypeRelation <em>Type Relation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link subkdm.kdmRelations.ClusterRelation <em>Cluster Relation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createClusterRelationAdapter() {
		return null;
	}
