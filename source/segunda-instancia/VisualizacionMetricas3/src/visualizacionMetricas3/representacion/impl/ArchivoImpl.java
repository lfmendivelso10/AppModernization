 ...
 * <ul>
 *   <li>{@link visualizacionMetricas3.representacion.impl.ArchivoImpl#getHijos <em>Hijos</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ArchivoImpl extends ElementoImpl implements Archivo {
	/**
	...
	protected EClass eStaticClass() {
		return RepresentacionPackage.Literals.ARCHIVO;
	}
	...
	public EList<Elemento> getHijos() {
		if (hijos == null) {
			hijos = new EObjectContainmentEList<Elemento>(Elemento.class, this, RepresentacionPackage.ARCHIVO__HIJOS);
		}
		return hijos;
	}
