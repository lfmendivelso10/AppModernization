 ...
 * <ul>
 *   <li>{@link subkdm.kdmObjects.impl.TemplateUnitImpl#getCodeElement <em>Code Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TemplateUnitImpl extends DataTypeImpl implements TemplateUnit {
	 ...
	 * @ordered
	 */
	protected EList<CodeUnit> codeElement;
	...
	protected EClass eStaticClass() {
		return KdmObjectsPackage.Literals.TEMPLATE_UNIT;
	}
	 ...
	 * @generated
	 */
	public EList<CodeUnit> getCodeElement() {
		if (codeElement == null) {
			codeElement = new EObjectContainmentEList<CodeUnit>(CodeUnit.class, this, KdmObjectsPackage.TEMPLATE_UNIT__CODE_ELEMENT);
		}
		return codeElement;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KdmObjectsPackage.TEMPLATE_UNIT__CODE_ELEMENT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case KdmObjectsPackage.TEMPLATE_UNIT__CODE_ELEMENT:
				...
				getCodeElement().addAll((Collection<? extends CodeUnit>)newValue);
				return;
		}
