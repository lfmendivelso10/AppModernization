 ...
 * <ul>
 *   <li>{@link subkdm.SimplifiedDecisionMetrics.impl.DimensionalMeasurementImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DimensionalMeasurementImpl extends MeasurementImpl implements DimensionalMeasurement {
	...
	protected EClass eStaticClass() {
		return SimplifiedDecisionMetricsPackage.Literals.DIMENSIONAL_MEASUREMENT;
	}
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplifiedDecisionMetricsPackage.DIMENSIONAL_MEASUREMENT__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimplifiedDecisionMetricsPackage.DIMENSIONAL_MEASUREMENT__VALUE:
				return getValue();
		}
