...
public class KdmRelationsFactoryImpl extends EFactoryImpl implements KdmRelationsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case KdmRelationsPackage.CLASS_LEVEL_RELATION: return createClassLevelRelation();
			case KdmRelationsPackage.TYPE_RELATION: return createTypeRelation();
			case KdmRelationsPackage.CLUSTER_RELATION: return createClusterRelation();
			default:
	 ...
	 * @generated
	 */
	public ClassLevelRelation createClassLevelRelation() {
		ClassLevelRelationImpl classLevelRelation = new ClassLevelRelationImpl();
		return classLevelRelation;
	}
	 ...
	 * @generated
	 */
	public ClusterRelation createClusterRelation() {
		ClusterRelationImpl clusterRelation = new ClusterRelationImpl();
