 ...
 * <ul>
 *   <li>{@link subkdm.kdmRelations.impl.AbstractCodeRelationshipImpl#getTo <em>To</em>}</li>
 *   <li>{@link subkdm.kdmRelations.impl.AbstractCodeRelationshipImpl#getFrom <em>From</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AbstractCodeRelationshipImpl extends ModelElementImpl implements AbstractCodeRelationship {
	/**
	...
	protected EClass eStaticClass() {
		return KdmRelationsPackage.Literals.ABSTRACT_CODE_RELATIONSHIP;
	}
		...
		if (to != null && to.eIsProxy()) {
			...
			if (to != oldTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KdmRelationsPackage.ABSTRACT_CODE_RELATIONSHIP__TO, oldTo, to));
			}
		}
		return to;
	}
	...
	public void setTo(AbstractCodeElement newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KdmRelationsPackage.ABSTRACT_CODE_RELATIONSHIP__TO, oldTo, to));
	}
	...
	public AbstractCodeElement getFrom() {
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KdmRelationsPackage.ABSTRACT_CODE_RELATIONSHIP__FROM, oldFrom, from));
			}
		}
		return from;
	}
	...
	public void setFrom(AbstractCodeElement newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KdmRelationsPackage.ABSTRACT_CODE_RELATIONSHIP__FROM, oldFrom, from));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KdmRelationsPackage.ABSTRACT_CODE_RELATIONSHIP__TO:
				if (resolve) return getTo();
				return basicGetTo();
			case KdmRelationsPackage.ABSTRACT_CODE_RELATIONSHIP__FROM:
