...
import subkdm.kdmObjects.Annotation;
...
public class KdmObjectsPackageImpl extends EPackageImpl implements KdmObjectsPackage {
	 ...
	 * @generated
	 */
	public EReference getCluster_CodeElement() {
	...
	public void createPackageContents() {
		...
		createEReference(clusterEClass, CLUSTER__CODE_ELEMENT);
	...
	public void initializePackageContents() {
		...
		commentUnitEClass.getESuperTypes().add(this.getModelElement());
		...
		clusterEClass.getESuperTypes().add(this.getCodeItem());

		// Initialize classes, features, and operations; add parameters
		initEClass(codeModelEClass, CodeModel.class, "CodeModel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCodeModel_CodeElement(), this.getModelElement(), null, "codeElement", null, 0, -1, CodeModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getModelElement_Annotation(), this.getAnnotation(), null, "annotation", null, 0, -1, ModelElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCluster_CodeElement(), this.getCodeItem(), null, "codeElement", null, 0, -1, Cluster.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
