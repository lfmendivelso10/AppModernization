...
public class KdmObjectsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case KdmObjectsPackage.ANNOTATION: {
			...
			case KdmObjectsPackage.CLUSTER: {
				Cluster cluster = (Cluster)theEObject;
				T result = caseCluster(cluster);
				if (result == null) result = caseCodeItem(cluster);
				if (result == null) result = caseAbstractCodeElement(cluster);
