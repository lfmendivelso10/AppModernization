 ...
 * <ul>
 *   <li>{@link visualizacionMetricas3.visualizacion.impl.PaqueteImpl#getDiagrama <em>Diagrama</em>}</li>
 *   <li>{@link visualizacionMetricas3.visualizacion.impl.PaqueteImpl#getName <em>Name</em>}</li>
 *   <li>{@link visualizacionMetricas3.visualizacion.impl.PaqueteImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link visualizacionMetricas3.visualizacion.impl.PaqueteImpl#getBorde <em>Borde</em>}</li>
 *   <li>{@link visualizacionMetricas3.visualizacion.impl.PaqueteImpl#getConectores <em>Conectores</em>}</li>
 *   <li>{@link visualizacionMetricas3.visualizacion.impl.PaqueteImpl#getElementos <em>Elementos</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PaqueteImpl extends EObjectImpl implements Paquete {
	...
	protected EClass eStaticClass() {
		return VisualizacionPackage.Literals.PAQUETE;
	}
		...
		if (diagrama != null && diagrama.eIsProxy()) {
			...
			if (diagrama != oldDiagrama) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VisualizacionPackage.PAQUETE__DIAGRAMA, oldDiagrama, diagrama));
			}
		}
		return diagrama;
	}
	...
	public void setDiagrama(Contenedor newDiagrama) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisualizacionPackage.PAQUETE__DIAGRAMA, oldDiagrama, diagrama));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisualizacionPackage.PAQUETE__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetLabel(Label newLabel, NotificationChain msgs) {
		...
		label = newLabel;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VisualizacionPackage.PAQUETE__LABEL, oldLabel, newLabel);
	...
	public void setLabel(Label newLabel) {
		if (newLabel != label) {
			...
			if (label != null)
				msgs = ((InternalEObject)label).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VisualizacionPackage.PAQUETE__LABEL, null, msgs);
			if (newLabel != null)
				msgs = ((InternalEObject)newLabel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VisualizacionPackage.PAQUETE__LABEL, null, msgs);
			msgs = basicSetLabel(newLabel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisualizacionPackage.PAQUETE__LABEL, newLabel, newLabel));
	}
	...
	public NotificationChain basicSetBorde(Borde newBorde, NotificationChain msgs) {
		...
		borde = newBorde;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VisualizacionPackage.PAQUETE__BORDE, oldBorde, newBorde);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBorde(Borde newBorde) {
		if (newBorde != borde) {
			NotificationChain msgs = null;
			if (borde != null)
				msgs = ((InternalEObject)borde).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VisualizacionPackage.PAQUETE__BORDE, null, msgs);
			if (newBorde != null)
				msgs = ((InternalEObject)newBorde).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VisualizacionPackage.PAQUETE__BORDE, null, msgs);
			msgs = basicSetBorde(newBorde, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisualizacionPackage.PAQUETE__BORDE, newBorde, newBorde));
	}
	...
	public EList<Conector> getConectores() {
		if (conectores == null) {
			conectores = new EObjectContainmentEList<Conector>(Conector.class, this, VisualizacionPackage.PAQUETE__CONECTORES);
		}
		return conectores;
	}
	...
	public EList<ElementoDiagrama> getElementos() {
		if (elementos == null) {
			elementos = new EObjectContainmentEList<ElementoDiagrama>(ElementoDiagrama.class, this, VisualizacionPackage.PAQUETE__ELEMENTOS);
		}
		return elementos;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisualizacionPackage.PAQUETE__DIAGRAMA:
